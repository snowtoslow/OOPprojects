...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        stringParser.nrOfLetters(text);//letters
        stringParser.nrOfSEntences(text);//sentences
        stringParser.nrOfConsAndWovels(text);//Cons and Vowels
        stringParser.nrOfWords(text);//WORDS
